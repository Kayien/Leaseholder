...
namespace ASPNET_Core_2_1.Data
{
    public class SeedDb
    {
        ...
        private async Task CheckPropertiesAsync()
        {
            ...
            {
                AddProperty("Calle 43 #23 32", "El Soler", owner, propertyType, 800000M, 2, 72, 4);
                AddProperty("Calle 12 Sur #2 34", "San Francisco", owner, propertyType, 950000M, 3, 81, 3);
                await _context.SaveChangesAsync();
            }
        }
        ...
        private async Task CheckOwnersAsync()
        {
            ...
            {
                AddOwner("8989898", "Juan", "Arrieta", "234 3232", "310 322 3221", "Calle Luna Calle Sol");
